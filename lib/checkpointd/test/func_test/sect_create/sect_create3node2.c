/* $Id: sect_create3node2.c,v 1.1 2004/06/30 03:44:20 deng.pan Exp $ */
/* 
 * sec_create3node2.c: Test data checkpoint function : saCkptSectionCreate 
 *
...
int main(int argc, char **argv)
{
	...
	/* wait for node 1 (active node) ready */
