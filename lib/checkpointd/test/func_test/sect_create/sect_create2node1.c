/* $Id: sect_create2node1.c,v 1.1 2004/06/30 03:44:20 deng.pan Exp $ */
/* 
 * sec_create2node1..c: Test data checkpoint function : saCkptSectionCreate 
 *
