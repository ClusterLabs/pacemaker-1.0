/* $Id: write7node1.c,v 1.1 2004/06/30 03:44:21 deng.pan Exp $ */
/* 
 * write7node1.c: Test data checkpoint function : saCkptCheckpointWrite 
 *
...
void initparam(void)
{
	...
	sectwrite.sectionId.idLen = sizeof (sect_id_array) ;
