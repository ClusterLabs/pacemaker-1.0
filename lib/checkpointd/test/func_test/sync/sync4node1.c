/* $Id: sync4node1.c,v 1.1 2004/06/30 03:44:21 deng.pan Exp $ */
/* 
 * sync4node1.c: Test data checkpoint function : saCkptCheckpointSynchronize 
 *
...
void initparam(void)
{
	...
	sectwrite.sectionId.idLen = sect_id.idLen ;
