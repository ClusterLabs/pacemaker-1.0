/* $Id: open1node1.c,v 1.1 2004/06/30 03:44:19 deng.pan Exp $ */
/* 
 * open1node1.c: Test data checkpoint function : saCkptCheckpointOpen 
 *
 ...
 * creates local replica now. In synchronous mode . 
 *	  If node 1 and node 2 both find them in the checkpoint replica list,
...
int main(int argc, char **argv)
{
	...
	/* local check ready, wait for remote node checking */
	syslog (LOG_INFO|LOG_LOCAL7, "ckpt_signal %d %d\n", count++, SIGUSR1) ;
	pause () ;
