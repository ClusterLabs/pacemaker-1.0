/* $Id: sect_delete4node2.c,v 1.1 2004/06/30 03:44:20 deng.pan Exp $ */
/* 
 * sec_delete4node2.c: Test data checkpoint function : saCkptSectionDelete 
 *
