/* $Id: close1node1.c,v 1.1 2004/06/30 03:44:19 deng.pan Exp $ */
/* 
 * close1node1.c: Test data checkpoint function : saCkptCheckpointClose 
 *
...
int main(int argc, char **argv)
{
	...
	/* wait for node 2 create and fork open ready */
	...
	/* wait for node 2 (active)create and fork open ready */
	syslog (LOG_INFO|LOG_LOCAL7, "ckpt_signal %d %d\n", count++, SIGUSR1) ;
	pause () ;
	...
	finalize () ;
	syslog (LOG_INFO|LOG_LOCAL7, "ckpt_success %d\n", SIGUSR1) ;
