/* $Id: overwrite3node2.c,v 1.1 2004/06/30 03:44:20 deng.pan Exp $ */
/* 
 * overwrite3node2.c: Test data checkpoint function : saCkptSectionOverwrite 
 *
 ...
 */
#define CkptOpenFlag SA_CKPT_CHECKPOINT_COLOCATED|SA_CKPT_CHECKPOINT_COLOCATED|SA_CKPT_CHECKPOINT_WRITE|SA_CKPT_CHECKPOINT_READ
#define CaseName "overwrite3"
