/*
 * cmpi_rsc_instance_provider.c: LinuxHA_ClusterResourceInstance provider
 * 
...
ClusterResourceInstance_AssociationCleanup(CMPIAssociationMI * mi, 
                CMPIContext * ctx);
CMPIStatus
ClusterResourceInstance_Associators(CMPIAssociationMI * mi, CMPIContext * ctx, 
                CMPIResult * rslt, CMPIObjectPath * op, const char * asscClass, 
                const char * resultClass,
                const char * role, const char * resultRole, char ** properties);
CMPIStatus
ClusterResourceInstance_AssociatorNames(CMPIAssociationMI * mi, CMPIContext * ctx, 
                CMPIResult * rslt, CMPIObjectPath * op, const char * asscClass, 
                const char * resultClass, const char * role, 
                const char * resultRole);
CMPIStatus
ClusterResourceInstance_References(CMPIAssociationMI * mi, CMPIContext * ctx, 
...
CMPIStatus
ClusterResourceInstance_Associators(CMPIAssociationMI * mi, 
                CMPIContext * ctx, CMPIResult * rslt, CMPIObjectPath * cop, 
                ...
                const char * role, const char * resultRole, char ** properties)
{
        ...
        DEBUG_ENTER();
        ret = enum_associators(Broker, ClassName, attr_ref, resource_ref,
...
CMPIStatus
ClusterResourceInstance_AssociatorNames(CMPIAssociationMI * mi, 
                CMPIContext * ctx, CMPIResult * rslt, CMPIObjectPath * cop, 
                const char * assocClass, const char * resultClass,
...
CMPIStatus
ClusterResourceInstance_References(CMPIAssociationMI * mi, 
                CMPIContext * ctx, CMPIResult * rslt,
                ...
                const char * role, char ** properties)
{
        ...
        init_logger(PROVIDER_ID);
        DEBUG_ENTER();
        ret = enum_references(Broker, ClassName, attr_ref, resource_ref, 
                              attr_class_name, resource_class_name,
...
DeclareInstanceMI(ClusterResourceInstance_,
                  LinuxHA_ClusterResourceInstanceProvider, Broker);
DeclareAssociationMI(ClusterResourceInstance_,
                  LinuxHA_ClusterResourceInstanceProvider, Broker);
