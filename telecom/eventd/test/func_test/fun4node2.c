...
#define EVENT_DATA  "Allocate Function Test Case node2"
#define Event_Priority 1
#define Event_retentionTime 2000
...
int main(int argc, char **argv)
{
	...
	memcpy(publisher_name.value, "f4node2", 7);
	...
	if (saEvtEventAttributesGet(event_handle, &pattern_array_out, 
		&priority, &retention_time, &publisher_name_out, 
